const ButtonLoading = ({ color }) => {
    console.log("color button loading: " + color);
    const buttonClass =
        "text-white focus:ring-4 focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 inline-flex items-center ";
    ...
    if (color == "yellow") {
        buttonClassColor =
            "bg-yellow-700 hover:bg-yellow-800 focus:ring-yellow-300 dark:bg-yellow-600 dark:hover:bg-yellow-700 dark:focus:ring-yellow-900";
    }
